...
def multiplicative_inverse(a, b):
    ...
    # Negative return values for i or j are made positive mod b or a respectively
    ...
    while b != 0:
        ...
        (y, ly) = ((ly - (q * y)), y)
    if lx < 0:
        lx += ob  # If negative: wrap modulo orignal b
    if ly < 0:
        ly += oa  # If negative: wrap modulo orignal a
